...
app.get('/likes/usuario/:id',          (req, res) => LikeController.listarPorUsuario(req, res));
...
app.get('/comentarios/usuario/:id',    (req, res) => ComentarioController.listarPorUsuario(req, res));
...
app.listen(3000, () => {
    console.log('Zerion rodando em http://localhost:3000');
    require('./src/js/ia/cron');
});